...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const defaultProps = {
    pointSize: 1,
    atmosphereColor: isDarkMode ? "#ffffff" : "#0c4a6e",
    showAtmosphere: true,
    atmosphereAltitude: isDarkMode ? 0.1 : 0.15,
    polygonColor: isDarkMode ? "rgba(255,255,255,0.7)" : "rgba(15,23,42,0.3)",
    globeColor: isDarkMode ? "#1d072e" : "#0369a1",
    emissive: isDarkMode ? "#000000" : "#0284c7",
    emissiveIntensity: isDarkMode ? 0.1 : 0.15,
    shininess: 0.9,
    arcTime: 2000,
    arcLength: 0.9,
    rings: 1,
...
export function World(props: WorldProps) {
  ...
  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(50, aspect, 180, 1800)} shadows>
      <WebGLRendererConfig />
      <ambientLight 
        color={globeConfig.ambientLight || (isDarkMode ? "#38bdf8" : "#0ea5e9")} 
        intensity={0.6} 
      />
      <directionalLight
